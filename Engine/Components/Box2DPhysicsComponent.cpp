...
namespace nu
{
    ...
    void Box2DPhysicsComponent::Update(float dt)
    {
        ...
        GetOwner()->SetRoation(GetRotaion() * math::RadToDeg);
    }
    ...
    {
        m_physicsBody->ApplyTorque(torque * math::DegToRad);
    }
    ...
    void Box2DPhysicsComponent::SetRotaion(float roation)
    {
        m_physicsBody->SetRotation(roation);
    }

    float Box2DPhysicsComponent::GetRotaion() const
    {
